...
/* nist heatmap — order must match backend _NIST_FUNCTIONS */
...
export default function DashboardPage() {
    ...
    // Build heatmap cells from real NIST coverage data.
    // Each cell level: 0=missing, 1=inactive, 2=draft, 3=active, -1=no policies at all
